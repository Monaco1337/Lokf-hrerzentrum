...
const WORK_STATE: Record<LeadStatus, WorkState> = {
  ...
  REPLIED: { label: "Antwort erhalten", dot: "bg-accent-500", pill: "bg-accent-50 text-accent-700 ring-accent-100" },
  FORWARDED: { label: "Weitergeleitet", dot: "bg-sky-500", pill: "bg-sky-50 text-sky-700 ring-sky-100" },
  LANDINGPAGE_OPENED: { label: "Landingpage geöffnet", dot: "bg-sky-600", pill: "bg-sky-50 text-sky-700 ring-sky-100" },
  FUNNEL_STARTED: { label: "Funnel gestartet", dot: "bg-violet-500", pill: "bg-violet-50 text-violet-700 ring-violet-100" },
  FUNNEL_COMPLETED: { label: "Funnel abgeschlossen", dot: "bg-violet-600", pill: "bg-violet-50 text-violet-700 ring-violet-100" },
