...
export const PIPELINE_RANK: Partial<Record<LeadStatus, number>> = {
  ...
  [LeadStatus.DOC_READY]: 12,
  [LeadStatus.AA_APPOINTMENT_PENDING]: 13,
  [LeadStatus.AA_APPOINTMENT_DONE]: 14,
  [LeadStatus.GUTSCHEIN_PENDING]: 15,
  [LeadStatus.GUTSCHEIN_APPROVED]: 16,
  [LeadStatus.ENROLLED]: 17,
  [LeadStatus.STARTED]: 18,
};
